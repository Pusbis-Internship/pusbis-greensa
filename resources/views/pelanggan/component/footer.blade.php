        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <h6>GreenSA Inn & Training Center</h6>
        ...
        <div class="container container-fluid">
            <div class="row">
                <div class="col-md-8 col-sm-6 col-xs-12">
                    <p class="copyright-text">Copyright @ GreenSa Inn & Training Center
                        <a href="#">PUSBIS UIN Sunan Ampel Surabaya</a>.
                    </p>
                </div>
        
                {{-- <div class="col-md-4 col-sm-6 col-xs-12">
                    <ul class="social-icons">
                        <li><a class="facebook" href="#"><i class="fab fa-facebook align-self-center"></i></a></li>

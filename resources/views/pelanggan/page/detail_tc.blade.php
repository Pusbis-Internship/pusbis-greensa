                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-4">
                            <div class="date" id="date2" data-target-input="nearest">
                                <input type="text" class="form-control" id="check-out" placeholder="Check out" data-target="#date2" value="" onfocus="(this.type='date')" />
                            </div>
                        </div>
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                    ...
                    <div class="col-6">
                        <fieldset disabled="disabled">
                            <div class="input-group input-group-sm">
                                <input type="number" class="form-control form-control-sm" id="capacityPax" placeholder="Kapasitas" value="200">
                ...
                <div class="d-flex">
                    ...
                    <button class="btn btn-outline-success flex-shrink-0 w-100" type="button" data-bs-toggle="modal" data-bs-target="#modalBook">

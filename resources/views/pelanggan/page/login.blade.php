            ...
            <div class="card border-light-subtle shadow-sm">
                <div class="row g-0">
                    <div class="col-12 col-md-6">
                        <img src="{{ asset('assets/images/login.png') }}" alt="Greensa Login"
                            class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" />
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div
                                        class="d-flex px-0 gap-2 gap-md-5 flex-column flex-md-row justify-content-md-evenly">
    ...
    {{-- <div>
        ...
        <form action="/guestlogin" method="POST">
            ...
            <div>
                ...
                <input type="text" id="username" name="username" class="{{ $errors->has('username') ? 'error' : '' }}"
                    required>
            </div>
    
            <div>
                <label for="password">Password:</label>
                <input type="password" id="password" name="password" class="{{ $errors->has('password') ? 'error' : '' }}"
                    required>
            </div>
